...
<body>
  ...
  <script>
    const fiamgaApi = new fdk.FigmaApi({
      clientId: 'SM2F7SZ0FM2ANHtUHeZQYY',
      clientSecrete: 'fUbZ2ETvoaSaLCU5fNyHYG2x6GT6Bk',
      redirectUri: 'https://k-jax.github.io/node_modules/figma-development-kit/dist/callback.html',
    });
